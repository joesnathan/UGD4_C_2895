...
import { FaApple, FaLemon,FaHeart,FaStar } from 'react-icons/fa';
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-linear-to-br from-indigo-900 via-purple-90 to-pink-800 p-4">
